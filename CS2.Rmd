...
Voter turnout by a number of different demographics such as age, race and party is a huge topic of interest for both pollsters and candidates, especially around presidential elections and with particular focus on swing states, such as North Caroline. In this case study we will use North Carolina registration and turnout data, by county, for the 2020 election year. We wish to investigate what demographic factors affect turnout and whether turnout differs by county. 
...
```{r}
# summary(mod6)$coefficients
>>>>>>> a530a267c6f7c96a10d3b3fd8fc05765e82cfd01
```
